...
"""
Script para testar o cliente SharePoint e diagnosticar o erro "File is not a zip file"
"""
...
logger = logging.getLogger('test_sharepoint')
...
def main():
    ...
    try:
        ...
        logger.info(f"Status do cache: {cache_status}")
